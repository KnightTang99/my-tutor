...
// //         //     text: '头像'+(i+1)
// //         //   }});
// //         // this.headList = [1,1,1,1];console.log(this.headList);
// //         this.headList.map((_val, i) => {
// //             console.log(1);
// //         //     return {
// //         //     icon: require(`../../assets/imgs/headers/头像${i+1}.png`),
// //         //     text: '头像'+(i+1)
...
// var obj1 = Object.assign(obj,{sex:3});
// console.log(obj);
// console.log(obj1);
...
// var now = moment(new Date(),'YYYY-MM-DD').format('YYYYMMDD');
// console.log(now);
